...
public class RegistryHandler {
    ...
    public static final RegistryObject<SwordItem> STEEL_SWORD = ITEMS.register("steel_sword", () -> new SwordItem(SteelItemTier.STEEL, ConfigHandler.steel_sword_damage - 3, ConfigHandler.steel_sword_attack_speed - 4F, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<ShovelItem> STEEL_SHOVEL = ITEMS.register("steel_shovel", () -> new ShovelItem(SteelItemTier.STEEL, 1.5F, -3.0F, (new Item.Properties().tab(CreativeModeTab.TAB_TOOLS))));
    ...
    public static final RegistryObject<AxeItem> STEEL_AXE = ITEMS.register("steel_axe", () -> new AxeItem(SteelItemTier.STEEL, ConfigHandler.steel_axe_damage - 3F, ConfigHandler.steel_axe_attack_speed - 4F, (new Item.Properties().tab(CreativeModeTab.TAB_TOOLS))));
    ...
    public static final RegistryObject<FlintAndSteelItem> QUARTZ_AND_STEEL = ITEMS.register("quartz_and_steel", () -> new FlintAndSteelItem(new Item.Properties().durability(ConfigHandler.quartz_and_steel_durability).tab(CreativeModeTab.TAB_TOOLS)));
    ...
    public static final RegistryObject<ArmorItem> STEEL_LEGGINGS = ITEMS.register("steel_leggings", () -> new ArmorItem(SteelArmorMaterial.STEEL, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<ArmorItem> STEEL_BOOTS = ITEMS.register("steel_boots", () -> new ArmorItem(SteelArmorMaterial.STEEL, EquipmentSlot.FEET, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    ...
    public static final RegistryObject<Item> STEEL_TRAPDOOR_ITEM = ITEMS.register("steel_trapdoor", () -> new BlockItem(STEEL_TRAPDOOR.get(), (new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE))));
    public static final RegistryObject<Item> STEEL_ANVIL_ITEM = ITEMS.register("steel_anvil", () -> new BlockItem(STEEL_ANVIL.get(), (new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS))));
    ...
    public static final RegistryObject<Item> DAMAGED_STEEL_ANVIL_ITEM = ITEMS.register("damaged_steel_anvil", () -> new BlockItem(DAMAGED_STEEL_ANVIL.get(), (new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS))));
