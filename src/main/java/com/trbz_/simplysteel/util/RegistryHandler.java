...
public class RegistryHandler {
    ...
    public static final RegistryObject<Item> CRUDE_IRON = ITEMS.register("crude_iron", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
    ...
    public static final RegistryObject<DoorBlock> STEEL_DOOR = BLOCKS.register("steel_door", () -> new DoorBlock(BlockBehaviour.Properties
    ...
    public static final RegistryObject<AxeItem> STEEL_AXE = ITEMS.register("steel_axe", () -> new AxeItem(SteelItemTier.STEEL, 6.0F, -3.1F, (new Item.Properties()).tab(CreativeModeTab.TAB_TOOLS)));
